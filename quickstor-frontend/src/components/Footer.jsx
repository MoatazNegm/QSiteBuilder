...
const Footer = ({ brandName, brandDescription, tagline, columns, copyright, legalLinks, style }) => (
  <footer className="bg-black py-12 md:py-16 border-t border-gray-900" style={style}>
