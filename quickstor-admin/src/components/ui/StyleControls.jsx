            ...
            <div className="space-y-1.5">
                ...
                <div className="relative">
                    <input
                        type="text"
                        list="font-presets"
                        value={styles.fontFamily ? styles.fontFamily.split(',')[0].replace(/['"]/g, '') : ''}
                        onChange={(e) => handleChange('fontFamily', `"${e.target.value}", sans-serif`)}
                        placeholder="e.g. Roboto, Inter, Open Sans"
                        className="w-full h-8 pl-2 pr-2 text-xs border border-gray-200 rounded-md bg-white text-gray-900 focus:outline-none focus:border-blue-500 placeholder:text-gray-400 font-mono"
                    />
